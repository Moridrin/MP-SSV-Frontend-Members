...
class FrontendMembersFieldTab extends FrontendMembersField
{
    ...
    {
        if ($active) {
            return '<li class="mui--is-active"><a class="btn btn--flat" data-mui-toggle="tab" data-mui-controls="pane-' . $this->id . '"><p class="' . $this->class . '" style="' . $this->style . '">' . $this->title . '</p></a></li>';
        } else {
            return '<li><a class="btn btn--flat" data-mui-toggle="tab" data-mui-controls="pane-' . $this->id . '"><p class="' . $this->class . '" style="' . $this->style . '">' . $this->title . '</p></a></li>';
        }
    }
