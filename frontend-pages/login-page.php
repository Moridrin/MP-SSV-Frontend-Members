...
function ssv_login_page_content($content)
{
    ...
    if (current_theme_supports('mui')) {
        ...
        <form name="loginform" id="loginform" action="/wp-login.php" method="post">
            ...
            <button class="btn btn--primary waves-effect waves-light button-primary" type="submit" name="wp-submit" id="wp-submit">Login</button>
        ...
        <form name="loginform" id="loginform" action="/wp-login.php" method="post">
            ...
            <button class="btn btn--primary waves-effect waves-light" type="submit" name="wp-submit" id="wp-submit">Login</button>
            <input type="hidden" name="redirect_to" value="<?= get_site_url() ?>/profile">
        </form>
        <br/>
        Don't have an account? <!--suppress HtmlUnknownTarget -->
