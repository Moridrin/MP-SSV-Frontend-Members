...
== Installation ==
1. Upload the plugin files to the `/wp-content/plugins/ssv-users` directory, or install the plugin through the WordPress plugins screen directly.
...
= 3.0.1 =
* Added support for sorting users on custom fields.
